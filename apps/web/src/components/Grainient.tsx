...
// Keeps renderer/program alive across re-renders
const ctxMap = new WeakMap<HTMLElement, { renderer: unknown; program: { uniforms: Record<string, { value: unknown }> }; mesh: unknown }>();
...
export default function Grainient({
  ...
  // Effect 2: sync props → uniforms (no WebGL rebuild)
  useEffect(() => {
    const container = containerRef.current;
    if (!container) return;
