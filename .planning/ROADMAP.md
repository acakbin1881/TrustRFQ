...
- [x] 01-03-PLAN.md — Admin-tunable spam pricing plus the auth, re-init, event and TTL test surface
...
- [x] 02-02-PLAN.md — Quote validation before any wallet prompt, with the stub maker's failure knobs proving it

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 02-03-PLAN.md — Discovery indicator, ranked quote list with countdowns and manual re-quote, and every declared UI state

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 02-04-PLAN.md — Trustline pre-flight and the price-guarded expired-entry retry
...
- [x] 03-03-PLAN.md — Both directions settled, five exact balance deltas per swap, and the committed machine-readable run artifact
